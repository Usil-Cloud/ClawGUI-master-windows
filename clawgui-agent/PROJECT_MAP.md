...
| 1-D | **Window Manager**            | `phone_agent/windows/window_manager.py`      | [docs/features/window_manager/_index.md](docs/features/window_manager/_index.md) | **active — current focus** |
| 1-E | Connection Manager            | `phone_agent/windows/connection.py`          | _pending_                                                           | active   |
